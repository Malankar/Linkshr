      ...
      <div className="pt-5 grid grid-cols-1 max-w-xs md:max-w-xl lg:max-w-3xl m-auto gap-4 text-white">
        <div className="relative">
          <input
            type="search"
            id="default-search"
            className="block p-4 pl-5 w-full text-sm rounded-lg border bg-gray-800 border-gray-800 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
